   ...
   extends PApplet
{
   ...
   */
   public void setup()
   {
      ...
      loadImages(view, IMAGE_LIST_FILE_NAME, imageStore, this);
   ...
   private static void loadImages(WorldView view, String filename, ImageStore imageStore,
      PApplet screen)
   {
      try
      {
         Scanner in = new Scanner(new File(filename));
         view.loadImages(in, imageStore, screen);
      }
